...
// Importing the 'Signup', 'Login', 'Dashboard', 'Profile', 'Layout', and 'ForgotPassword' components
  ...
  const router = createBrowserRouter([
    {
      ...
      children: [
        {
          path: "/",
          element: <Dashboard />, // Dashboard component is rendered for the root path under Layout
        },
        {
          path: "/profile",
